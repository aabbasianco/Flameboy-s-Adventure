...
public class EnemyController : MonoBehaviour
{
    ...
    public float chaseDistance, loseDistance, chaseSpeed;
    ...
    void Update()
    {
        if (dyingCounter > 0)
        {
            ...
            transform.localScale = Vector3.Lerp(transform.localScale, new Vector3(1.25f, .5f, 1.25f), squashSpeed);
        ...
        else
        {
            switch (currentState)
            {
                ...
                case EnemyState.chasing:
                    ...
                    if (Vector3.Distance(transform.position, thePlayer.transform.position) > loseDistance)
                    {
